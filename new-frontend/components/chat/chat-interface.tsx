            ...
            <div className={cn("space-y-6", collapsed && "space-y-4")}>
                ...
                <div className="space-y-3">
                    ...
                    {sessionsQuery.isLoading ? (
                        ...
                        <div className="rounded-[24px] border border-dashed border-white/10 bg-white/5 p-4 text-sm text-muted-foreground">
                            Persistent chats will show up here after the first
                            message.
                        </div>
                    )}
                </div>
                ...
                <div className="space-y-3">
                    ...
                    {projectsQuery.isLoading ? (
                        ...
                        <div className="rounded-[24px] border border-dashed border-white/10 bg-white/5 p-4 text-sm text-muted-foreground">
                            Projects give you a scoped source set and a separate
                            persistent thread.
                        </div>
                    )}
                </div>
            ...
            <Card>
                ...
                <CardContent className="space-y-3">
                    {activeProject?.sources.length ? (
                        ...
                        <div className="rounded-[24px] border border-dashed border-white/10 bg-white/5 p-4 text-sm text-muted-foreground">
                            Add papers from the library or uploads workspace to
                                ...
                                <Card className="flex min-h-0 flex-1 flex-col overflow-hidden">
                                    <CardHeader className="flex flex-row items-start justify-between gap-3">
                                        ...
                                        >
                                            ...
                                            <CardDescription>
                                                Switch between general chats and
                    ...
                    <div className="space-y-6">
                                ...
                                {activeWorkspace.type === "project" ? (
                                    activeProject?.overview ? (
                                        ...
                                        <div className="rounded-[24px] border border-dashed border-white/10 bg-white/5 p-4 text-sm text-muted-foreground">
                                            ...
                                            overview yet. Once you start
                                            curating sources here, this panel
                                            can show a higher-level summary.
                                        </div>
                                    )
                                ) : (
                                    <div className="rounded-[24px] border border-dashed border-white/10 bg-white/5 p-4 text-sm text-muted-foreground">
                                        Session titles are derived from the
                                        first user message and stay separate
                                        from project threads.
                                    </div>
                                )}
                        ...
                        <Card className="h-fit">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    These map directly to the backend request
                                    body for both sessions and projects.
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6">
                                ...
                                <div className="rounded-[24px] border border-dashed border-white/10 bg-white/5 p-4 text-sm leading-6 text-muted-foreground">
                                    All chat requests are sent synchronously.
                                </div>
                            </CardContent>
                        </Card>
                    </div>
                ...
                <SheetContent side="left" className="w-[92vw] sm:w-96">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                            Jump between persistent general chats and
                            project-specific threads.
                        </p>
                    </div>
            ...
            >
                <DialogContent className="max-w-xl">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Projects keep a separate source list and a separate
